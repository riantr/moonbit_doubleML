...
```console
moon test --target native  --deny-warn   # 113/113
moon test --target wasm-gc --deny-warn   # 113/113
moon test --target wasm    --deny-warn   # 113/113
moon test --target js      --deny-warn   # 113/113
```
